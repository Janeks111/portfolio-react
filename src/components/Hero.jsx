  ...
  return (
    ...
    >
      <div className="w-full h-full relative flex items-end justify-center">
        {/* -------circle-------- */}
        <div className="circle bg-purple-500 w-[35vw] sm:w-[80vw] h-[35vw] sm:h-[80vw] rounded-full absolute bottom-0 sm:bottom-[10%] left-[50%] translate-x-[-50%] shadow select-none"></div>
        {/* ------- heading------ */}
        ...
        {/* -------circle-------- */}
        <img
          className="absolute bottom-0 left-[-50%] translate-x-[50%] w-full h-[45%] sm:h-[70%] object-contain select-none opacity-100"
